...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center pt-24 pb-24 relative overflow-hidden bg-transparent">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col lg:flex-row items-center gap-16 max-w-7xl">
        ...
        <Reveal delay={600} className="hidden lg:block flex-1 relative">
